...
ActiveRecord::Schema.define(version: 20150102232015) do
  ...
  add_index "jobs", ["org_id"], name: "index_jobs_on_org_id", using: :btree
  ...
  create_table "orgs", force: :cascade do |t|
    ...
    t.string   "desc",       default: "Description"
    t.string   "contact",    default: "Contact info"
  end
